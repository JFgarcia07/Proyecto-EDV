 ...
 * @author jfgarcianata
 */
@WebServlet(name = "DesactivarComentariosEmpresa", urlPatterns = {"/DesactivarComentariosEmpresa"})
public class DesactivarComentariosEmpresa extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String idEmpresa = SesionGlobal.idEmpresa;

        int codigoRespuesta = crud.desactivarComentariosEmpresa(idEmpresa);
